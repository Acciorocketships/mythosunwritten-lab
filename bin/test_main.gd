...
const SUITES := [
	...
	preload("res://tests/test_weapon_patterns.gd"),
	...
	preload("res://tests/test_walk_in_fight.gd"),
	preload("res://tests/test_fight_cooloff.gd"),
	preload("res://tests/test_window_glow.gd"),
	preload("res://tests/test_board_overlay.gd"),
	preload("res://tests/test_board_legend.gd"),
	...
	preload("res://tests/test_ui_digits.gd"),
	preload("res://tests/test_panel_sentences.gd"),
]
