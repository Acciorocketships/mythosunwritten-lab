extends SceneTree
## Run just the tool-budget suite, print the result, exit non-zero if
## any expectation failed.
##
## Run it with:  ./run_budget_suite.sh


func _initialize() -> void:
	var suite: TestSuite = preload("res://tests/test_tool_budget.gd").new()
	suite.run()
