...
##
## Five faces were drawn when the weapon catalogue grew: a greatsword, an axe, a
## crossbow, a wand and a spellbook became shapes an item can be, and a shape a
## person can be carrying is a row in a bag that has to have a face. Each is its
## own sixteen rows rather than a re-use, because the point of a face in a bag is
## telling one thing from another at a glance -- a wand pointing at the staff's
## face would be the mistake `gear_dagger` was drawn to undo.
const GEAR := {
	AssetTags.GEAR_BLADE: "hand",
	AssetTags.GEAR_DAGGER: "dagger",
	AssetTags.GEAR_GREATSWORD: "greatsword",
	AssetTags.GEAR_AXE: "axe",
	AssetTags.GEAR_SPEAR: "spear",
	AssetTags.GEAR_BOW: "bow",
	AssetTags.GEAR_CROSSBOW: "crossbow",
	AssetTags.GEAR_STAFF: "staff",
	AssetTags.GEAR_WAND: "wand",
	AssetTags.GEAR_SPELLBOOK: "spellbook",
